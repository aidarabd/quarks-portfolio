      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-24 pb-20 w-full">
        <div className="max-w-4xl">
          ...
          <p className="text-xl text-slate-400 leading-relaxed max-w-2xl mb-10">
            From manual processes to intelligent digital systems — we deliver
            custom software that automates operations, integrates systems, and
            creates measurable efficiency for businesses and government agencies.
          </p>
